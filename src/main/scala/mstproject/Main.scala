...
object Main extends App {
    ...
    val datasets = List(("src/main/resources/out.moreno_train_train", " ", true), ("src/main/resources/facebook_combined.txt", " ", false), ("src/main/resources/roadNet-CA.txt", "\t" , false), ("src/main/resources/com-orkut.ungraph.txt", "\t", false))
      .map(d => graphDataset(d._1, d._2, d._3))
    ...
    lazy val orkutEdges = file"${datasets(3).path}".lines.map( l => l.split(datasets(3).delim).map(_.toInt) ).toList
